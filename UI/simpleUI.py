...
#
# Created: Sat Apr 24 21:45:54 2010
...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        QtCore.QObject.connect(self.pushButton_2, QtCore.SIGNAL("clicked(bool)"), self.checkBox.setChecked)
        QtCore.QObject.connect(self.pushButton_4, QtCore.SIGNAL("clicked()"), MainWindow.saveDataToCSV)
        QtCore.QObject.connect(self.checkBox, QtCore.SIGNAL("clicked(bool)"), MainWindow.loadDataFromDso)
